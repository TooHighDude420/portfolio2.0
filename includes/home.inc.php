    ...
    <div class="flex flex-col justify-center items-center">
        <div class="text-cont flex flex-col justify-center items-center max-w-[80%]">
            ...
            <div class="lato-regular subtext">
                <p>
                    Vroeger toen ik een jaar of 10 was, had ik een video gezien op YouTube waar iemand een CMD-programma
                    had
                    gemaakt dat op het iconische Matrix patroon lijkt. Helemaal verwonderd had ik de code gekopieerd om
                    het
                    zelf
                    uit te proberen, ik snapte er natuurlijk nog niks van. Maar het heeft er wel voor gezorgd dat ik
                    geïnteresseerd ben geworden in programmeren.
                </p>
                <br>
                <p>
                    Nadat ik het succesvol had nagedaan ben ik zelf gaan experimenteren met de dingen die ik kon doen,
                    wat
                    er
                    uiteindelijk voor heeft gezorgd dat ik mijn eerste programma heb gemaakt. Een keuzemenu wat
                    verschillende
                    programma’s voor je kon openen zoals notepad en internetbrowser, aan het begin werd je naam gevraagd
                    en
                    er
